// Catálogo F-DATO-01 v1.0 — textos aprobados por Asamblea General

var CONSENTIMIENTOS = [
  {
    codigo: 'C1',
    titulo: 'General obligatorio',
    referencia: 'Art. 12 — SICE-POL-01',
    version: '1.0',
    obligatorio_sistema: true,
    texto_html: '<p>Declaro que leí, acepto y autorizo a DiversoLAB la recolección y uso de mis datos básicos y de contacto (nombre, correo electrónico, teléfono, dirección).</p><p><strong>OBLIGATORIO.</strong> La negativa imposibilita la prestación del servicio.</p>'
  },
  {
    codigo: 'C2',
    titulo: 'Identificación mínima',
    referencia: 'Art. 13 — SICE-POL-01',
    version: '1.0',
    obligatorio_sistema: true,
    texto_html: '<p>Declaro que leí, acepto y autorizo a DiversoLAB el registro y uso de mi información de identificación personal. El acceso a estos datos estará restringido a personal autorizado.</p><p><strong>OBLIGATORIO.</strong> Necesario para la prestación del servicio.</p>'
  },
  {
    codigo: 'C3',
  ...
  {
    codigo: 'C4',
    titulo: 'Analítica, modelos predictivos e inteligencia artificial',
  ...
  {
    codigo: 'C6',
    titulo: 'Imagen, voz y testimonios',
  ...
  {
    codigo: 'C7',
    titulo: 'Seguimiento psicosocial y educativo',
